...
openai_api_key = os.getenv("eyJhbGciOiJIUzI1NiJ9.eyJlbWFpbCI6IjIyZHMyMDAwMDkxQGRzLnN0dWR5LmlpdG0uYWMuaW4ifQ.-bLj3zVGOkq8TiW1DDM19cayzI35sNOTq10BqiIUlik")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--email", default="22ds2000091@ds.study.iitm.ac.in", help="Set the email address")
